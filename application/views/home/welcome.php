        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="home">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                      <a class="nav-link js-scroll-trigger" href="#fitur"><i class="fa fa-bars" aria-hidden="true"></i> Fitur</a>
                    </li>
                    <li class="nav-item">
					...
					<li class="nav-item">
          			...
          			<a href="<?php echo base_url('login'); ?>"><button class="btn btn-outline-primary my-2 my-sm-0" type="submit"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Masuk</button></a>
        				
                </div>
        </nav>
    </header><br><br>
	<!--Container gambar-->
	<div class="warna text-center" id="atas">
		<div>
			<img class="" src="<?php echo base_url(); ?>assets/dashboard/welcome/images/Logo.png" alt="Generic Placeholder image" width="100%" height="100%"/>
		</div>
	</div>
		<!--Marquee-->
		<style>
...
<h3>Selamat Datang di Sistem Informasi Administrasi Penduduk | USB Smart City 2018 </h3>
	  ...
	  <!-- Three columns of text below the carousel -->
	  	<div class="container" id="fitur">
			...
			<div class="row">
				<div class="col-md">
					<img src ="<?php echo base_url(); ?>assets/dashboard/welcome/images/regist.gif" weight=350 height=350>
						<div class="card bg-info text-white">
							<div class="card-body">Daftar & Registrasi</div>
  						</div>
					</div>
				<div class="col-md">
					<img src ="<?php echo base_url(); ?>assets/dashboard/welcome/images/load.gif" weight=350 height=350>
						<div class="card bg-info text-white">
							<div class="card-body">Tunggu Proses</div>
  						</div>
					</div>
				<div class="col-md">
					<img src ="<?php echo base_url(); ?>assets/dashboard/welcome/images/finish.gif" weight=350 height=350>
						<div class="card bg-info text-white">
  ...
  <div class="container-fluid">
      <div class="asymmetric" id="Informasi">
	  		<div class="text-center">
		  		<div class="row">
					<div class="col-md">
					 <img src="<?php echo base_url(); ?>assets/dashboard/welcome/images/user.png" alt="Avatar" width=150 height=150>
						<div id="value">0</div><a>Jumlah User<a>
					</div>
					<div class="col-md">
					 <img src="<?php echo base_url(); ?>assets/dashboard/welcome/images/files.png" alt="Avatar" width=150 height=150>
						<div id="value1">0</div><a>Jumlah User<a>
					</div>
					<div class="col-md">
					 <img src="<?php echo base_url(); ?>assets/dashboard/welcome/images/sukses.png" alt="Avatar" width=150 height=150>
						<div id="value2">0</div><a>Jumlah User<a>
					</div>
				</div>
			</div>
			</div>
...
<!--div class="container-fluid">
    		  <div class="asymmetric" id="Informasi">
			  <div class="text-center">
			  <img src="images/user.png" alt="Avatar" width=80 height=80>
	  						<div id="value">0</div><a>Jumlah User<a>
      			</div><br><br>
					<div class="text-center">
				<img src="images/files.png" alt="Avatar" width=80 height=80>
	  						<div id="value1">0</div><a>Jumlah Surat<a>
      			</div><br><br>
					<div class="text-center">
					<img src="images/sukses.png" alt="Avatar" width=80 height=80>
...
<br>
    ...
    <a href="<?php echo base_url('registrasi'); ?>"><button type="button" class="btn btn-primary btn-lg"><i class="fa fa-retweet" aria-hidden="true"></i> Daftar</button></aa>
...
<br>
  <div class="row-kotak text-center" id="">
		...
		<!--Asymetri2c-->
		<div class="container-fluid">
    		  <div class="bentuk" id="Helpdesk"><div class="text-center">
			  <img src="images/Help.png" alt="Avatar" width=200 height=200>
  ...
  <tbody>
    ...
    <tr>
      ...
      <footer class="container">
			 <div class = "text-center">
			 	<a class="js-scroll-trigger" href="#atas">
			 		<button class ="btn btn-outline-secondary"><i class="fa fa-angle-up"></i> Kembali ke atas</button>
    			 </a>
				 <hr>
          <p>&copy; SIAP | 2018 USB Smart City &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
		  </div>
        </footer>
